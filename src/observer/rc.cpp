...
const char *strrc(RC rc)
{
  switch (rc) {
    ...
    RC_CASE_STRING(RECORD_RECORD_NOT_EXIST_4);
    RC_CASE_STRING(RECORD_RECORD_NOT_EXIST_3);
    RC_CASE_STRING(RECORD_RECORD_NOT_EXIST_2);
    RC_CASE_STRING(RECORD_RECORD_NOT_EXIST_1);
